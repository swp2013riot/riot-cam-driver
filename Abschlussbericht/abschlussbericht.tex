...
% draft mode.
%
\documentclass[12pt,final,journal,a4paper]{IEEEtran}
...
\author{Philipp~Rosenkranz, Maximilian~Ferdinand~Müller}% <-this % stops a space
...
% The paper headers
\markboth{Softwareprojekt Telematik 2013}%
{Softwareprojekt Telematik 2013}
...
\section{Einleitung}
\IEEEPARstart{D}{ieses} Softwareprojekt hatte zum Ziel, einen Gerätetreiber für einen USB-Video-Grabber für RIOT zu entwickeln.
